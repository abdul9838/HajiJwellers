...
const Checkout = () => {
    const { cartItems, totalPrice, discount } = useContext(ProductContext)
    return (
        <Layout>
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 bg-slate-50">
                    ...
                    <div className="">
                        ...
                        <div className="mt-6 border-t border-b py-2">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <p className="font-semibold text-gray-900">${totalPrice * discount / 100}</p>
                            </div>
                        </div>
                        <div className="mt-6 flex items-center justify-between">
                            <p className="text-sm font-medium text-gray-900">Total</p>
                            <p className="text-2xl font-semibold text-gray-900">${totalPrice - totalPrice * discount / 100}</p>
                        </div>
                    </div>
